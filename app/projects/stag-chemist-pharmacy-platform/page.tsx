...
export default function StagChemistProject() {
  ...
  const features = [
    {
      ...
      description: 'Comprehensive admin panel for adding, editing, and managing pharmacy products with real-time inventory tracking'
    },
    {
      title: 'Blog Management',
      description: 'Dynamic blog system with content management, categories, and SEO optimization for health-related articles'
    },
    {
      title: 'Stripe Payment Integration',
      description: 'Secure and seamless payment processing with Stripe for online prescription and product purchases'
    },
    {
      title: 'Beautiful UI/UX',
      description: 'Modern, responsive design optimized for pharmacy customers with intuitive navigation and accessibility'
    },
    {
      title: 'Firebase Backend',
      description: 'Scalable Firebase backend with real-time database, authentication, and hosting services'
    },
    {
      title: 'UK Local Pharmacy Focus',
      description: 'Tailored for UK pharmacy regulations and local customer needs with prescription management'
    }
  ];
  ...
  const challenges = [
    {
      ...
      solution: 'Implemented secure Stripe payment system with proper PCI compliance and UK pharmacy payment regulations'
    },
    {
      title: 'Admin Panel Complexity',
      solution: 'Created intuitive admin dashboard with role-based access and comprehensive product management tools'
    },
    {
      title: 'Blog System Architecture',
      solution: 'Developed flexible content management system with markdown support and SEO optimization'
    },
    {
      title: 'UK Pharmacy Compliance',
      solution: 'Ensured compliance with UK pharmacy regulations including data protection and prescription handling'
    }
  ];
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 py-12">
          ...
          <div className="text-center">
            ...
            <p className="text-lg text-purple-100 mb-8 max-w-3xl mx-auto leading-relaxed">
              UK-based local pharmacy website with React frontend and Firebase backend, featuring admin panel for product management, 
              blog system, and Stripe payment gateway integration with beautiful UI/UX design.
            </p>
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <div className="flex items-center gap-2 bg-white/10 backdrop-blur-sm px-3 py-1.5 rounded-full">
                ...
                <span className="text-purple-100 font-medium text-sm">React & Firebase</span>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="space-y-4">
              ...
              <div className="relative rounded-xl overflow-hidden shadow-lg bg-gray-100 dark:bg-gray-800">
                <img
                  ...
                  alt="Stag Chemist Pharmacy Platform Screenshot"
              ...
              <div className="flex gap-2 overflow-x-auto pb-2">
                {images.map((image, index) => (
                  ...
                  >
                    <img
                      src={image}
                      alt={`Stag Chemist Screenshot ${index + 1}`}
              ...
              <div>
                ...
                <ul className="space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span className="text-gray-600 dark:text-gray-300">Product management system with real-time inventory</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-purple-600 mt-1">•</span>
                    <span className="text-gray-600 dark:text-gray-300">Dynamic blog system with content management</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-purple-600 mt-1">•</span>
                    <span className="text-gray-600 dark:text-gray-300">Stripe payment gateway integration</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-purple-600 mt-1">•</span>
                    <span className="text-gray-600 dark:text-gray-300">Beautiful and responsive UI/UX design</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-purple-600 mt-1">•</span>
                    <span className="text-gray-600 dark:text-gray-300">Firebase backend with real-time database</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-purple-600 mt-1">•</span>
                    <span className="text-gray-600 dark:text-gray-300">UK pharmacy compliance and regulations</span>
                  </li>
                </ul>
              </div>
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-indigo-900 via-purple-800 to-pink-900 text-white rounded-2xl">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 py-12 text-center">
          <h2 className="text-3xl font-bold mb-4">
            Ready to Build Your Pharmacy Platform?
          </h2>
          <p className="text-lg text-purple-100 mb-8 max-w-2xl mx-auto">
            Let's create a comprehensive pharmacy solution with beautiful design and powerful functionality.
          </p>
