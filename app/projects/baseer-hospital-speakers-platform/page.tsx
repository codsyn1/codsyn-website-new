...
export default function BaseerHospitalProject() {
  const [activeImage, setActiveImage] = useState(0);

  const images = [
    '/baseerhospital01.png',
    '/baseerhospital02.png'
  ];

  const features = [
    {
      title: 'TTC Control System',
      description: 'Advanced admin panel for complete control over speaker schedules, bookings, and event management'
    },
    {
      title: 'Speaker Management',
      description: 'Comprehensive speaker profiles with bios, expertise areas, and availability tracking'
    },
    {
      title: 'Event Scheduling',
      description: 'Dynamic calendar system with automated reminders and conflict detection for speaker events'
    },
    {
      title: 'Main Project Hub',
      description: 'Centralized dashboard for managing all speaker events, projects, and organizational activities'
    },
    {
      title: 'Real-time Updates',
      description: 'Live status updates and notifications for speakers and event coordinators'
    },
    {
      title: 'Professional Profiles',
      description: 'Detailed speaker profiles with photos, credentials, and presentation history'
    }
  ];

  const challenges = [
    {
      title: 'TTC Integration Complexity',
      solution: 'Developed custom API integration with TTC systems for seamless data synchronization and real-time updates'
    },
    {
      title: 'Admin Panel Security',
      solution: 'Implemented role-based access control with secure authentication and audit trails for admin operations'
    },
    {
      title: 'Speaker Data Management',
      solution: 'Created efficient database structure for handling large volumes of speaker information and event data'
    },
    {
      title: 'Real-time Synchronization',
      solution: 'Built WebSocket connections for live updates across multiple admin panels and user interfaces'
    }
  ];
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 py-12">
          ...
          <div className="text-center">
            ...
            <p className="text-lg text-purple-100 mb-8 max-w-3xl mx-auto leading-relaxed">
              Professional speakers website with admin panel for TTC control and comprehensive main project management system.
            </p>
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <div className="flex items-center gap-2 bg-white/10 backdrop-blur-sm px-3 py-1.5 rounded-full">
                ...
                <span className="text-purple-100 font-medium text-sm">React & Admin</span>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="space-y-4">
              ...
              <div className="relative rounded-xl overflow-hidden shadow-lg bg-gray-100 dark:bg-gray-800">
                <img
                  ...
                  alt="Baseer Hospital Speakers Platform Screenshot"
              ...
              <div className="flex gap-2 overflow-x-auto pb-2">
                {images.map((image, index) => (
                  ...
                  >
                    <img
                      src={image}
                      alt={`Baseer Hospital Screenshot ${index + 1}`}
              ...
              <div>
                ...
                <ul className="space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span className="text-gray-600 dark:text-gray-300">Advanced TTC control system</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-purple-600 mt-1">•</span>
                    <span className="text-gray-600 dark:text-gray-300">Speaker management and profiles</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-purple-600 mt-1">•</span>
                    <span className="text-gray-600 dark:text-gray-300">Event scheduling and calendar</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-purple-600 mt-1">•</span>
                    <span className="text-gray-600 dark:text-gray-300">Main project hub dashboard</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-purple-600 mt-1">•</span>
                    <span className="text-gray-600 dark:text-gray-300">Real-time updates and notifications</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-purple-600 mt-1">•</span>
                    <span className="text-gray-600 dark:text-gray-300">Professional speaker profiles</span>
                  </li>
                </ul>
              </div>
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-indigo-900 via-purple-800 to-pink-900 text-white rounded-2xl">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 py-12 text-center">
          <h2 className="text-3xl font-bold mb-4">
            Ready to Build Your Speakers Platform?
          </h2>
          <p className="text-lg text-purple-100 mb-8 max-w-2xl mx-auto">
            Let's create a comprehensive speaker management system with advanced admin controls.
          </p>
