  ...
  const features = [
    {
      ...
      description: 'Complete order taking and tracking system for dine-in, takeaway, and delivery'
    },
    {
      title: 'Inventory Control',
      description: 'Real-time stock management with automatic alerts and reorder suggestions'
    },
    {
      title: 'Billing & Invoicing',
      description: 'Automated bill generation with multiple payment options'
    },
    {
      title: 'Invoice Printing',
      description: 'Professional invoice templates with customizable branding'
    },
    {
    ...
    },
    {
      ...
      description: 'Real-time delivery status and driver management'
    }
  ];
  ...
  const challenges = [
    {
      ...
      solution: 'Implemented real-time database for instant order and inventory updates'
    },
    {
      title: 'Multi-device Support',
      solution: 'Developed responsive system for tablets, desktops, and mobile devices'
    },
    {
      title: 'Payment Integration',
      solution: 'Integrated multiple payment gateways with secure processing'
    },
    {
      title: 'Performance Optimization',
      solution: 'Optimized database queries and caching for fast response times'
    }
  ];
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 py-12 pt-16">
          ...
          <div className="text-center">
            ...
            <p className="text-lg text-purple-100 mb-6 max-w-3xl mx-auto leading-relaxed">
              Complete POS software for restaurants managing inventory, stocks, orders, bills, invoice printing, dining, and delivery operations with comprehensive business management features.
            </p>
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <div className="flex items-center gap-2 bg-white/10 backdrop-blur-sm px-3 py-1.5 rounded-full">
                ...
                <span className="text-purple-100 font-medium text-sm">Desktop POS</span>
              </div>
            </div>
          </div>
        </div>
              ...
              <div>
                ...
                <ul className="space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span className="text-gray-600 dark:text-gray-300">Order management for dine-in, takeaway, and delivery</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-purple-600 mt-1">•</span>
                    <span className="text-gray-600 dark:text-gray-300">Real-time inventory control with stock alerts</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-purple-600 mt-1">•</span>
                    <span className="text-gray-600 dark:text-gray-300">Automated billing and invoicing system</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-purple-600 mt-1">•</span>
                    <span className="text-gray-600 dark:text-gray-300">Professional invoice printing with branding</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-purple-600 mt-1">•</span>
                    <span className="text-gray-600 dark:text-gray-300">Table management and reservation system</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-purple-600 mt-1">•</span>
                    <span className="text-gray-600 dark:text-gray-300">Real-time delivery tracking and management</span>
                  </li>
                </ul>
              </div>
              
              {/* Note: Desktop Software - No Live Preview Available */}
              <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-700 rounded-lg p-4">
                <div className="flex items-center gap-2 text-blue-600 dark:text-blue-400">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                  <span className="font-medium text-sm">Desktop Software</span>
                </div>
                <p className="text-gray-600 dark:text-gray-300 text-sm mt-2">This is a desktop POS software application. Contact us for a demo.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Comprehensive restaurant management solution with powerful features designed to streamline operations and boost efficiency.
            </p>
          </div>
      ...
      <section className="py-16 bg-gray-50 dark:bg-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Overcoming complex technical challenges to deliver a robust and scalable POS solution.
            </p>
          </div>
      ...
      <section className="py-16 bg-gradient-to-r from-purple-600 to-purple-800 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 max-w-3xl mx-auto">
            Ready to streamline your restaurant operations? Get in touch with us to learn how our POS system can revolutionize your business.
          </p>
