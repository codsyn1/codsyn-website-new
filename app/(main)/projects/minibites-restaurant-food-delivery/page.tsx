...
export default function MinibitesProject() {
  ...
  const features = [
    {
      ...
      description: 'Live order status updates with GPS tracking for delivery partners and customers'
    },
    {
      title: 'Multi-restaurant Support',
      description: 'Seamless integration with multiple restaurants and menu management'
    },
    {
    ...
    },
    {
      ...
      description: 'Secure login system with email, phone, and social media authentication'
    },
    {
      title: 'Push Notifications',
      description: 'Real-time notifications for order updates, promotions, and delivery alerts'
    },
    {
      title: 'Rating & Reviews',
      description: 'Comprehensive rating system with customer feedback and review management'
    }
  ];
  ...
  const challenges = [
    {
      ...
      solution: 'Implemented Firebase real-time database for instant order status updates'
    },
    {
      title: 'Payment Integration',
      solution: 'Integrated Stripe SDK with secure tokenization and multiple payment methods'
    },
    {
      title: 'Performance Optimization',
      solution: 'Used lazy loading and efficient state management for smooth app performance'
    },
    {
      title: 'Cross-platform Compatibility',
      solution: 'Leveraged Flutter\'s single codebase for consistent iOS and Android experience'
    }
  ];
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 py-12 pt-16">
          ...
          <div className="text-center">
            ...
            <p className="text-lg text-purple-100 mb-6 max-w-3xl mx-auto leading-relaxed">
              Transform your restaurant business with our comprehensive food delivery platform. 
              Built with cutting-edge Flutter technology and Firebase backend.
            </p>
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <div className="flex items-center gap-2 bg-white/10 backdrop-blur-sm px-3 py-1.5 rounded-full">
                ...
                <span className="text-purple-100 font-medium text-sm">Flutter Mobile</span>
              </div>
            </div>
          </div>
        </div>
              ...
              <div className="flex gap-2 overflow-x-auto pb-2">
                {images.map((image, index) => (
                  ...
                  >
                    <img
                      src={image}
                      alt={`Minibites Screenshot ${index + 1}`}
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-300 mb-6">
                  Comprehensive restaurant management and food delivery application built with Flutter and Firebase, 
                  featuring real-time order tracking and seamless user experience.
                </p>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span className="text-gray-600 dark:text-gray-300">Real-time order tracking with GPS</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-purple-600 mt-1">•</span>
                    <span className="text-gray-600 dark:text-gray-300">Multi-restaurant support</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-purple-600 mt-1">•</span>
                    <span className="text-gray-600 dark:text-gray-300">Secure payment gateway</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-purple-600 mt-1">•</span>
                    <span className="text-gray-600 dark:text-gray-300">User authentication system</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-purple-600 mt-1">•</span>
                  ...
                  <li className="flex items-start gap-2">
                    <span className="text-purple-600 mt-1">•</span>
                    <span className="text-gray-600 dark:text-gray-300">Rating & review system</span>
                  </li>
                </ul>
              </div>
              ...
              <div>
                <a 
                  href="https://play.google.com/store/apps/details?id=com.minibites.app"
                  target="_blank"
                  rel="noopener noreferrer"
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-indigo-900 via-purple-800 to-pink-900 text-white rounded-2xl">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 py-12 text-center">
          ...
          <p className="text-lg text-purple-100 mb-8 max-w-2xl mx-auto">
            Let's create a comprehensive restaurant and delivery solution tailored to your business needs.
          </p>
